...
describe("UnifiedWeather", () => {
  ...
  test("renders empty state", () => {
    ...
    expect(
      screen.getByText("Search for a location to see weather information"),
    ).toBeInTheDocument();
  });

  test("renders with current weather data only", () => {
    render(
      <UnifiedWeather currentData={mockCurrentData} forecastData={null} />,
    );
  ...
  test("renders with forecast data only", () => {
    render(
      <UnifiedWeather currentData={null} forecastData={mockForecastData} />,
    );
